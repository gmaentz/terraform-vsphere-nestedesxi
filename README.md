...
This repo contains a set of modules for deploying a [VMware Nested ESXi](https://www.vaultproject.io/) cluster on the
[VMware](https://aws.amazon.com/) hypervisor, ESXi using [Terraform](https://www.terraform.io/).
